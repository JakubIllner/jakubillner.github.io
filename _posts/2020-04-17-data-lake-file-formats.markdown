Best File Formats for Data Lake on Oracle Object Storage
========================================================
...
-   What throughput can we expect when converting data into target
    formats?

-   How much time is spent on conversion compared to upload to Object
    Storage?
...
![](media/image1.png){width="6.5784722222222225in"
height="3.0816447944006997in"}

Figure 1 - Simple Data Lake Architecture
...
![](media/image2.png){width="6.751445756780402in"
height="1.624793307086614in"}

Figure 2 - File Conversion Process
...
-   CSV, JSON, Avro, and Parquet are commonly used formats, no surprise
    there.

-   I did not test ORC format as it is not well supported by Python and
    pandas.

-   I did not test other formats supported by pandas as they are not
    supported by ADW.

-   I did not test compression of CSV and JSON as pandas cannot do it in
    memory.

-   I used two packages for Avro, as avro-python3 turned out to be very
    slow.
...
![](media/image3.png){width="6.664583333333334in"
height="2.0081277340332457in"}

Figure 3 - File Size Conversion Ratios -- Large File
...
![](media/image4.png){width="6.777083333333334in"
height="2.285055774278215in"}

Figure 4 - File Conversion Throughput -- Large File
...
![](media/image5.png){width="6.776388888888889in"
height="2.4769531933508313in"}

Figure 5 - File Conversion Duration - Large File

![](media/image6.png){width="6.749305555555556in"
height="2.485678040244969in"}

Figure 6 - File Conversion Duration - Medium File

![](media/image7.png){width="6.749305555555556in"
height="2.520201224846894in"}

Figure 7 - File Conversion Duration - Small File
...
![](media/image8.png){width="6.685416666666667in"
height="2.199942038495188in"}

Figure 8 - Memory Consumption in kB - Large File

![](media/image9.png){width="6.684027777777778in"
height="2.163013998250219in"}

Figure 9 - Memory Consumption in kB - Medium File
